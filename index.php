<?php
    ...
    $domain = "https://www.lazada.vn/pages/i/vn/act/lp-flash-sale?spm=a2o4n.home.feature_nav.4.19056afeNcF3R4&wh_weex=true&hybrid=1&scm=1003.4.icms-zebra-5000379-2586391.OTHER_5276656988_2391686";
    // Content to search for existence
    $content = "google-analytics.com/ga.js";
    // Tag in which you look for the content
    //$content_tag = "script";
    $content_tag = "flash-unit";
    ...
    while ($domain != "" && $rounds < $max_urls_to_check) {
        ...
        $div_a_class_nodes = getElementsByClass($classname, 'div', 'div');
        

        //foreach ($doc->getElementsByTagName($content_tag) as $tag) {
        foreach ($doc->getAttribute($content_tag) as $tag) {
            print_r($tag);die;
