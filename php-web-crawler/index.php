    ...
    <body>
        <div id="content" style="margin-top:10px;height:100%;">
            ...
            <form action="index.php" method="POST">
                URL : <input name="url" placeholder="http://www.subinsb.com" value="<?php if(isset($_POST['url'])) echo $_POST['url'];?>"/>
                <input type="submit" name="submit" value="Start Crawling"/>
            </form>
            <br/>
            <b>URL bạn gửi để thu thập thông tin được ghi lại.</b><br/>Xem tất cả URL được thu thập thông tin <a href="url-crawled.html">tại đây</a>.<br/><br/>
            <?php
            ...
            function crawl_site($u) {
                ...
                //if ((array_key_exists($uen, $crawled_urls) == 0 || $crawled_urls[$uen] < date("YmdHis", strtotime('-25 seconds', time())))) {
                    ...
                    //print_r($html);die('fffdffff');
                    $crawled_urls[$uen] = date("YmdHis");
                    //print_r($html->find('div.unit-content'));die('fffdffff');
                    
                    foreach ($html->find('h5.mgg-list-mgg-title') as $li) {
                        print_r($li->outertext);die;
